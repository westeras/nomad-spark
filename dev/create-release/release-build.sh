...
MVN="build/mvn --force"
PUBLISH_PROFILES="-Pmesos -Pnomad -Pyarn -Phive -Phive-thriftserver -Phadoop-2.2"
...
if [[ "$1" == "package" ]]; then
  ...
  make_binary_release "hadoop2.4-without-hive" "-Psparkr -Phadoop-2.4 -Pyarn -Pmesos -Pnomad" "3037" &
